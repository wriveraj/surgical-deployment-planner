...
A relational database project simulating a surgical instrument and implant deployment operation across six hospital sites. Built to demonstrate real-world field inventory planning, Advanced Allocation workflows, inspection-based readiness tracking, and restock flag management using PostgreSQL.
...
- **Tibial Baseplate at SITE-01** — failed inspection with a confirmed case on April 15. Highest priority restock.
- **Acetabular Cup at SITE-02** — inspection still pending for an April 15 confirmed case. Risk of same-day scramble.
- **Radial Head at SITE-04** — Urgent case on April 16 with no inspection completed yet.
