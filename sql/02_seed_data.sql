...
('SITE-03', 'Hospital', 'Zone C', 'ST'),
('SITE-04', 'Hospital', 'Zone D', 'ST'),
('SITE-05', 'Hospital', 'Zone E', 'ST'),
('SITE-06', 'Hospital', 'Zone F', 'ST'),
...
(1, 1, '2026-04-15', 'Surgeon A', 'Total Knee Replacement', 2, 'Confirmed', 'Standard'),
(2, 1, '2026-04-15', 'Surgeon A', 'Total Knee Replacement', 2, 'Confirmed', 'Standard'),
(5, 1, '2026-04-15', 'Surgeon A', 'Total Knee Replacement', 1, 'Confirmed', 'Standard'),
(8, 2, '2026-04-15', 'Surgeon B', 'Total Hip Replacement', 2, 'Confirmed', 'Standard'),
(11, 2, '2026-04-15', 'Surgeon B', 'Total Hip Replacement', 1, 'Confirmed', 'Standard'),
(13, 3, '2026-04-16', 'Surgeon C', 'Shoulder Arthroplasty', 2, 'Planned', 'Standard'),
(17, 4, '2026-04-16', 'Surgeon D', 'Elbow Replacement', 2, 'Planned', 'Urgent'),
(20, 5, '2026-04-17', 'Surgeon E', 'Trauma Repair', 3, 'Planned', 'Emergency'),
(1, 6, '2026-04-17', 'Surgeon F', 'Total Knee Replacement', 2, 'Planned', 'Standard'),
(8, 1, '2026-04-18', 'Surgeon A', 'Hip Revision', 2, 'Planned', 'Urgent'),
(22, 2, '2026-04-18', 'Surgeon B', 'Trauma Nail Fixation', 2, 'Planned', 'Standard'),
(3, 3, '2026-04-19', 'Surgeon C', 'Total Knee Replacement', 2, 'Planned', 'Standard'),
(13, 4, '2026-04-19', 'Surgeon D', 'Shoulder Replacement', 2, 'Planned', 'Standard'),
(9, 5, '2026-04-20', 'Surgeon E', 'Total Hip Replacement', 1, 'Planned', 'Standard'),
(20, 6, '2026-04-21', 'Surgeon F', 'Trauma Plating', 3, 'Planned', 'Urgent');
...
(1, 1, 'Tech A', '2026-04-09', 'Pass', 'No damage found', TRUE),
(2, 2, 'Tech A', '2026-04-09', 'Pass', 'Minor surface wear, acceptable', TRUE),
(3, 5, 'Tech A', '2026-04-10', 'Fail', 'Component cracked — remove from service', FALSE),
(4, 8, 'Tech A', '2026-04-11', 'Pass', 'Clean, ready for redeployment', TRUE),
(5, 11, 'Tech A', '2026-04-11', 'Pending', 'Awaiting full inspection', FALSE),
(6, 13, 'Tech A', '2026-04-12', 'Pass', 'No issues found', TRUE),
(7, 15, 'Tech A', '2026-04-12', 'Fail', 'Glenoid component scratched — failed QC', FALSE),
(8, 17, 'Tech A', '2026-04-13', 'Pass', 'Ready for redeployment', TRUE),
(9, 19, 'Tech A', '2026-04-13', 'Pending', 'Awaiting inspection', FALSE),
(10, 20, 'Tech A', '2026-04-14', 'Pass', 'Good condition', TRUE),
(11, 22, 'Tech A', '2026-04-14', 'Fail', 'Nail bent — unusable', FALSE),
(12, 3, 'Tech A', '2026-04-15', 'Pass', 'Cleared', TRUE),
(13, 6, 'Tech A', '2026-04-15', 'Pass', 'Cleared', TRUE);
